...
void Co2FromAdc::init()
{
    ...
    adc1_config_channel_atten(ADC1_CHANNEL_6, ADC_ATTEN_DB_11); //ADC_ATTEN_DB_11 = 0-3,6V (or 3.9V??)
...
int Co2FromAdc::getCO2()
{
    ...
    uint32_t mVoltRaw = esp_adc_cal_raw_to_voltage(ADC1_CHANNEL_6, &characteristics);
    if (mVoltRaw <= 200)
    {
